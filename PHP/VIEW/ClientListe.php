...
<div class="ligne">
    ...
    <div class="bloc titre">Id Ville</div>
...
?>
    <div class="ligne">
        ...
        <div class="bloc contenu"><?php echo $elt->getidVille() ?></div>
        <a href="index.php?action=ClientForm&m=modif&id=<?php echo $elt->getIdClient() ?>">
            <div class="bouton">Modifier</div>
        </a>
        <?php 
            if ($lvl==2){
                echo    '<a href="index.php?action=ClientForm&m=suppr&id=<?php echo $elt->getIdClient() ?>">
